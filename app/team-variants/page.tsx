...
import { variants } from "@/components/sections/team-variants";

export const metadata = { title: "Team — Variants" };

const PREVIEW_WIDTH = 1440;
const SCALE = 0.34;
const CARD_HEIGHT = 540;

export default function TeamVariantsIndex() {
  return (
    <div className="bg-paper px-6 pb-24 pt-40 md:px-10 lg:px-16">
      <div className="mx-auto max-w-[1440px]">
        ...
        <header className="mb-12 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="mt-3 font-display text-[clamp(2.5rem,5vw,3.75rem)] font-medium leading-[1]">
              Team page — <em className="text-accent">three directions.</em>
            </h1>
            <p className="mt-4 max-w-[640px] text-[15px] leading-[1.55] text-muted">
              Three macro layouts to compare before we commit. Click any variant
              to see it full-width with prev / next nav (or use arrow keys).
            </p>
          </div>
          <Link
            href="/"
        ...
        {/* Grid of scaled previews — 1 col mobile, 2 col tablet, 3 col desktop */}
