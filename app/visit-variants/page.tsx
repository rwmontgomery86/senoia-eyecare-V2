...
import { variants } from "@/components/sections/visit-variants";

export const metadata = { title: "Visit — Variants" };

const PREVIEW_WIDTH = 1440;
const SCALE = 0.34;
const CARD_HEIGHT = 540;

export default function VisitVariantsIndex() {
  return (
        ...
        <header className="mb-12 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="mt-3 font-display text-[clamp(2.5rem,5vw,3.75rem)] font-medium leading-[1]">
              Visit section — <em className="text-accent">four directions.</em>
            </h1>
