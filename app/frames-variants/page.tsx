...
import { variants } from "@/components/sections/frames-variants";

export const metadata = { title: "Frames — Variants" };

const PREVIEW_WIDTH = 1440;
const SCALE = 0.34;
const CARD_HEIGHT = 660;

export default function FramesVariantsIndex() {
  return (
        ...
        <header className="mb-12 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-[640px] text-[15px] leading-[1.55] text-muted">
              Three macro-different takes on a Maui Jim feature. Click any
              variant to see it full-width with prev / next nav. Layouts only —
              copy and photography will tighten after picking a direction.
            </p>
          </div>
          <Link
            href="/"
